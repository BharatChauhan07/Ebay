...
public class Utils {
    ...
    public void androidSetup() throws MalformedURLException {
        ...
        caps.setCapability("app", System.getProperty("user.dir") + "/build/Ebay.apk");
        caps.setCapability("package", "org.wordpress.android");
        caps.setCapability("appActivity", "org.Ebay.android.ui.WPLaunchActivity");
    ...
    public void iosSetup() throws MalformedURLException {
        ...
        File app = new File(appDir, "Ebay.app");
