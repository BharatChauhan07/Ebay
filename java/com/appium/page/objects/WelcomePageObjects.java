...
public class WelcomePageObjects {
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/fab_button")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/my_site_comments_text_view")
    @SelendroidFindBy(id = "my_site_comments_text_view")
    @iOSFindBy(id = "Comments")
    public MobileElement COMMENT;

    @AndroidFindBy(id = "org.Ebay.android:id/my_site_title_label")
    @SelendroidFindBy(id = "my_site_title_label")
    @iOSXCUITFindBy(accessibility = "vodqademo.Ebay.com")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/switch_site")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/title")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/my_site_view_site_text_view")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/viewpager_main")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/scroll_view")
