...
public class LoginPageObjects {
    ...
    @CacheLookup
    @AndroidFindBy(id = "org.Ebay.android:id/nux_username")
    ...
    @CacheLookup
    @AndroidFindBy(id = "org.Ebay.android:id/nux_password")
    ...
    @AndroidFindBy(id = "org.Ebay.android:id/nux_add_selfhosted_button")
    ...
    @CacheLookup
    @AndroidFindBy(id = "org.Ebay.android:id/nux_url")
